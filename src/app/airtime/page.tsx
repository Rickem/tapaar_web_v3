...
const packagePrices: Record<string, Record<string, number[]>> = {
  mtn: {
    Internet: [100, 200, 250, 500, 1000, 2000],
    Illimité: [250, 1250, 5000, 10000, 15000],
    Maxi: [100, 200, 500, 1500],
    "Maxi+Internet": [100, 200, 500, 1500],
  },
  moov: {
    "Pass Bonus": [100, 150, 200, 500, 1000, 1500, 2500, 5000,],
    "Pass+Internet": [100, 150, 200, 500, 1000, 1500, 2500, 5000,],
    Internet: [
      100, 150, 200, 250, 300, 500, 1000, 1250, 2000,],
    Illimité: [5000, 10000, 15000, 20000],
  },
  celtiis: {
